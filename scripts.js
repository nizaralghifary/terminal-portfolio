document.addEventListener('DOMContentLoaded', () => {
    ...
    const commands = {
        help: () => {
            return 'Available commands: <strong>help</strong>, <strong>project</strong>, <strong>whois</strong>, <strong>whoami</strong>, <strong>email</strong>, <strong>clear</strong>, <strong>history</strong>, <strong>sudo</strong>';
        },
        project: () => {
            return 'Projects: <a href="https://notes-app.nizaralghifary.my.id" target="_blank">Notes App</a>, <a href="https://memoirix.nizaralghifary.my.id" target="_blank">Memoirix</a>';
        },
        whois: () => {
